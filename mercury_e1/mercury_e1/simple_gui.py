...
from mercury_e1_interfaces.srv import SetAngles, SetCoords, GripperStatus, GetCoords, GetAngles


class WindowNode(Node):
    """ROS2 node with Tkinter GUI interface for controlling a Mercury robotic arm.
    ...
    def get_initial_angles(self):
        ...
        Returns:
            list: [joint_1, joint_2, joint_3, joint_4, joint_5, joint_6, joint_7]
        """
        ...
        if result is not None:
            return [result.joint_1, result.joint_2, result.joint_3,
                    result.joint_4, result.joint_5, result.joint_6, result.joint_7]
        else:
    ...
    def send_angles(self, angles):
        ...
        Args:
            angles (list): List of 7 joint angle values.
        """
    ...
    def update_gui(self):
        ...
        try:
            ...
            if angles:
                ...
                for i, var in enumerate(self.cont_all[:7]):
                    var.set(self.safe_get_angle(self.res_angles, i))
...
def main(args=None):
    """Initialize the ROS2 node and launch the Tkinter GUI for Mercury.
