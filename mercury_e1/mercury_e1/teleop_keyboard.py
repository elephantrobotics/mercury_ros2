...
MSG = """\
Mercury E1 Teleop Keyboard Controller
---------------------------
...
class TeleopKeyboardNode(Node):
    """ROS2 node for controlling Mercury via keyboard inputs."""
    ...
    def get_initial_angles(self):
        ...
        if future.result() is not None:
            return [future.result().joint_1, future.result().joint_2, future.result().joint_3,
                    future.result().joint_4, future.result().joint_5, future.result().joint_6, future.result().joint_7]
        else:
