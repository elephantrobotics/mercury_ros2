...
from mercury_e1_interfaces.srv import SetAngles, SetCoords, GetCoords, GripperStatus, GetAngles, GetGripperValue
import pymycobot
...
class MercuryDriver(Node):
    ...
    def __init__(self):
        """Initialize MercuryDriver node, publishers, and services."""
        ...
        time.sleep(0.05)
        if self.mercury_e1.get_fresh_mode() != 0:
    ...
    def publish_joint_states(self):
        ...
        try:
            ...
            joint_names = ["Joint1", "Joint2", "Joint3", "Joint4", "Joint5", "Joint6", 'Joint7', "gripper_controller"]  
    ...
    def set_angles_callback(self, request, response):
        ...
        Args:
            request (SetAngles.Request): The request object containing target joint
                angles (joint_1 to joint_7) and movement speed.
...
def main(args=None):
    """Main entry point for running the MercuryDriver node."""
